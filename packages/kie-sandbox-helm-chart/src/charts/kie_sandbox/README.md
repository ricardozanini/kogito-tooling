...
| image            | object | `{"account":"apache","name":"incubator-kie-sandbox-webapp","pullPolicy":"IfNotPresent","registry":"docker.io","tag":"1.36.0"}`                                                                                                                   | Image source configuration for the KIE Sandbox image                                                                                      |
